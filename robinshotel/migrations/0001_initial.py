# Generated by Django 4.2.5 on 2023-09-26 11:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='robinshotel.hotels')),
            ],
        ),
        migrations.CreateModel(
            name='Reservation',
            fields=[
                ...
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='robinshotel.rooms')),
            ],
        ),
    ]
